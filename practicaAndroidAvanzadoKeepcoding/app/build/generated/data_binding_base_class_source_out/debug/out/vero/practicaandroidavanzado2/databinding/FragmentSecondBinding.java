...
public final class FragmentSecondBinding implements ViewBinding {
  ...
  @NonNull
  public final Button buttonSecondtothird;
  ...
  private FragmentSecondBinding(@NonNull NestedScrollView rootView, @NonNull Button buttonSecond,
      @NonNull Button buttonSecondtothird, @NonNull LinearLayout linearLayoutButtons,
      @NonNull TextView textviewSecond) {
    this.rootView = rootView;
    this.buttonSecond = buttonSecond;
    this.buttonSecondtothird = buttonSecondtothird;
  ...
  public static FragmentSecondBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.button_secondtothird;
      Button buttonSecondtothird = ViewBindings.findChildViewById(rootView, id);
      if (buttonSecondtothird == null) {
        break missingId;
      }

      id = R.id.linearLayout_buttons;
      ...
      return new FragmentSecondBinding((NestedScrollView) rootView, buttonSecond,
          buttonSecondtothird, linearLayoutButtons, textviewSecond);
    }
